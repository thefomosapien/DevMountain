angular.module('itunes').controller('mainCtrl', function ($scope, itunesService, itunesCleanup) {
    ...
    $scope.getItunesService = function () {

        itunesService.getSongData().then(function (result) {
